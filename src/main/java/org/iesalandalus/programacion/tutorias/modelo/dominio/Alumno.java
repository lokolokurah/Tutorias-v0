package org.iesalandalus.programacion.tutorias.modelo.dominio;
...
public class Alumno {
	...
	static int ultimoIdentificador;
	...
	{
		return String.format("nombre=%s (%s), correo=%s, expediente=%s", getNombre(), getIniciales(), getCorreo(), getExpediente());
	}
